    ...
    <div class="row justify-content-center">
        <div class="col-sm-5">
            <form method="post" action="{{ route('register') }}">
                ...
                <div class="row">
                    <input id="phone" class="form-control @error('phone') is-invalid @enderror @if(old('phone')) is-valid @endif" type="tel" name="phone" value="{{ old('phone') }}" maxlength=11 placeholder="Mobile Phone Number (01XXXXXXXXX)">
                    @error('phone')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
